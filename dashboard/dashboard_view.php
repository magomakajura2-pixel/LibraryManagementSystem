        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body d-grid gap-2">
                    <a href="<?= BASE_URL ?>/borrowings/issue_book.php" class="btn btn-lms"><i class="bi bi-box-arrow-up-right me-1"></i> Issue Book</a>
                    <a href="<?= BASE_URL ?>/returns/return_book.php" class="btn btn-gold"><i class="bi bi-box-arrow-in-down-left me-1"></i> Return Book</a>
                    <a href="<?= BASE_URL ?>/books/add_book.php" class="btn btn-outline-secondary"><i class="bi bi-plus-circle me-1"></i> Add Book</a>
                    <a href="<?= BASE_URL ?>/members/add_member.php" class="btn btn-outline-secondary"><i class="bi bi-person-plus me-1"></i> Register Member</a>
                </div>
            </div>
