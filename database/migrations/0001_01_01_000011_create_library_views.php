...
return new class extends Migration
{
    ...
    {
        DB::statement("DROP VIEW IF EXISTS vw_book_availability");
        DB::statement("CREATE VIEW vw_book_availability AS
        ...
        DB::statement("DROP VIEW IF EXISTS vw_member_summary");
        DB::statement("CREATE VIEW vw_member_summary AS
            SELECT m.member_id,
        ...
        DB::statement("DROP VIEW IF EXISTS vw_most_borrowed_books");
        DB::statement("CREATE VIEW vw_most_borrowed_books AS
        ...
        DB::statement("DROP VIEW IF EXISTS vw_overdue_books");
        DB::statement("CREATE VIEW vw_overdue_books AS
